...
TEST(SimpleLocking_SimpleLocking) {
  deque<Txn*> ready_txns;
  SimpleLocking lm(&ready_txns);
  vector<Txn*> owners;
...
TEST(SimpleLocking_LocksReleasedOutOfOrder) {
  deque<Txn*> ready_txns;
  SimpleLocking lm(&ready_txns);
  vector<Txn*> owners;
...
int main(int argc, char** argv) {
  SimpleLocking_SimpleLocking();
  SimpleLocking_LocksReleasedOutOfOrder();
}
